...
TECHNO_IMG = "https://telegra.ph/file/145436dd8dc78b9f44828.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/MAMBA_X_SUPPORT")],
                                                                                   [InlineKeyboardButton(text="ADD MAMBA SUPPORT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/SUKHPAL443/MAMBAXPRO")
                                                                                 ]]))
